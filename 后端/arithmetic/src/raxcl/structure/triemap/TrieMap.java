...
public class TrieMap<V> {
    ...
    private void traverse(TrieNode<V> node, StringBuilder path, String pattern, int i, List<String> res) {
        ...
        //todo 如何匹配的？ 不理解-----大致理解了，扫描完匹配符，然后检查 node 是否为空
    ...
    private boolean hasKeyWithPattern(TrieNode<V> node, String pattern, int i) {
        ...
        // 没有遇到通配符
        if (c != '.') {
            // 从node.children[c] 节点开始匹配 pattern[i+1..]
            //todo node.children[c]只有一个吗？----是的
    ...
    public static void main(String[] args) {
        ...
        trieMap.put("app", 5);
        trieMap.put("that", 6);
        System.out.println(trieMap.get("the"));
//        trieMap.remove("that");
        System.out.println(trieMap.hasKeyWithPrefix("thata"));
        System.out.println(trieMap.shortestPrefixOf("thems"));
        System.out.println(trieMap.longestPrefixOf("thems"));
        System.out.println(trieMap.keysWithPrefix("th"));
        System.out.println(trieMap.keysWithPattern("t.a."));
        System.out.println(trieMap.hasKeyWithPattern("t.a."));
    }
}
