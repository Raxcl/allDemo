<template>
  <div
    ...
    <div v-show="mainShow">
      <div class="vue-live2d-tip"  v-show="true" :style="{top: fixtiptop + 'px'}">你好</div>
...
export default {
  ...
  data () {
    return {
      ...
      height: 0,
      tips: () => tips,
      homePage: 'https://github.com/evgo2017/vue-live2d',
  ...
  computed: {
    live2dWidth () {
      return this.width ? this.width : 255
    },
    live2dHeight () {
